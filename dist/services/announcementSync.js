...
async function setLastNewsId(newsid) {
    const client = await pool_1.pool.connect();
    try {
        await client.query(`
...
async function fetchPage(fromDate, toDate, page) {
    ...
    try {
        const response = await axios_1.default.get(BASE_URL, { params, headers: HEADERS, timeout: 15000 });

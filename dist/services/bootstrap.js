...
exports.bootstrapMasterList = bootstrapMasterList;
const pool_1 = require("../db/pool");
const csvParser_1 = require("./csvParser");
async function bootstrapMasterList() {
    console.log('Phase 1: Bootstrapping Master Sync...');
    const companies = await (0, csvParser_1.parseCompaniesJson)();
    const bhavcopyMapping = await (0, csvParser_1.parseBhavcopy)();
